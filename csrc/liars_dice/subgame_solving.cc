...
namespace liars_dice
{
  ...
  namespace
  {
    ...
    protected:
      ...
      {
        if (pseudo_leaves_indices.empty())
          return;
  ...
  // Query is composed of next player id, traverser (whether it should traverse or not 0 or 1),
  // which action was previously taken (action == state.lastbid)
  // and beliefs1 and beliefs2
