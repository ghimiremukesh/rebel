 ...
 */
  ...
  public:
    ...
    // Checks size in a thread-safe manner
    ...
    // Checks size in a not thread-safe manner
    // What is the purpose of this? Don't we always want to check in a safe manner?
    int size() const
    {
      std::unique_lock<std::mutex> lk(m_);
      return size_;
  ...
  public:
    ...
    // add weights based on priority? What is this priorityreplay for?
